<p align="center">
  <img src="assets/logo-sem-fundo.svg" alt="Valeris Logo" width="180" />
</p>
...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\backup_banco.ps1
```

- Restore:

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\restaurar_banco.ps1 -ArquivoBackup .\backups\ARQUIVO.sql
```

- Saude:

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\verificar_saude.ps1
```

## Documentacao complementar

- `README_PRODUCAO.md`
- `GUIA_ESTRUTURA_PTBR.md`

---

Release atual: `v3.0.0`
