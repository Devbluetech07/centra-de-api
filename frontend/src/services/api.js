...
export function setServiceKey(token) {
    localStorage.setItem("serviceKey", token);
}
export function getServiceKey() {
    return localStorage.getItem("serviceKey") ?? "";
}
export async function createToken(name, scopes, expiresInDays) {
...
export async function validateServiceKey(token) {
...
export async function revokeAllTokens(ids) {
...
export async function verifyBluepointFace(payload) {
